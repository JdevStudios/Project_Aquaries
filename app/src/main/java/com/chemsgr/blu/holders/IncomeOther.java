package com.chemsgr.blu.holders;
...
import com.chemsgr.blu.Map;
import com.chemsgr.blu.R;
import com.chemsgr.blu.custom.MessageSelectD;
import com.chemsgr.blu.custom.ReactCustom;
import com.chemsgr.blu.global.Global;

import com.chemsgr.blu.mediachat.VideoA;
...
//view init
        ...
        if (message.getType().equals("voice")) {
            ...
            url = "https://maps.googleapis.com/maps/api/staticmap?center=" + Double.parseDouble(lat) + "," + Double.parseDouble(lng) + "&zoom=15&size=300x300&maptype=roadmap&format=png&visual_refresh=true&" +
                    "markers=color:red%7Clabel:"+Global.currname+"%7C"+Double.parseDouble(lat) + "," + Double.parseDouble(lng)+"&key=" + Global.conA.getResources().getString(R.string.google_maps_key);
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            ...
                            }else
                            {
                                ...
                                m_amAudioManager.setMode(AudioManager.AUDIOFOCUS_GAIN);
                                m_amAudioManager.setSpeakerphoneOn(true);
                            }
