...
public class CallingActivity extends AppCompatActivity {
    ...
    private void onRemoteUserLeft() {
        state.setText("Other party left the call");
    }
    ...
    public void onSwitchSpeakerphoneClicked(View view) {
        ...
        if (iv.isSelected()) {
            ...
            Intent jumptocall = new Intent(CallingActivity.this, MainActivity.class);
            jumptocall.addFlags(Intent.FLAG_ACTIVITY_PREVIOUS_IS_TOP);
        ...
        mTokenget.child(friendid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(mAuth.getCurrentUser()!= null) {
                    ...
                    map.put("type", "voice");
                    map.put("to", friendid);
                    map.put("message", encryption.encryptOrNull(channelid + "#plax!!ah#&&plax#" + mAuth.getCurrentUser().getUid() + "#plax!!ah#&&plax#" + Global.nameLocal + "#plax!!ah#&&plax#" + Global.avaLocal));
